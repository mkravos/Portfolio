                ...
                <div className="container is-narrow"><a className="logo has-text-white" href="/">
                    ...
                    <div className="columns is-centered">
                        <div className="column is-one-third">
                            <h1 className="title is-size-4 has-text-white-muted has-text-weight-normal">Let's connect!</h1>
                        </div>
                    </div>
                    <div className="footer-icons">
                        <p className="field">
                            <a className="Footer-button button is-medium" href="https://www.linkedin.com/in/majkravos/" target="_blank noopener noreferrer">
                            ...
                            <a className="Footer-button button is-medium" href="https://github.com/mkravos" target="_blank noopener noreferrer">
                                <span className="icon is-small">
                            ...
                            <a className="Footer-button button is-medium" href="mailto:maj@kravos.me">
                                <span className="icon is-small">
