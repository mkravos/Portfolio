    ...
    return (
        <div>
            <footer class="Footer section is-primary is-small has-text-centered">
                <div class="container is-narrow"><a class="logo has-text-white" href="/">
                    <img className="Footer-logo logo" style={{ width: 100 }} src={logo} alt='logo' />
                </a>
                    <div class="columns is-centered">
                        <div class="column is-one-third">
                            <h1 class="title is-size-4 has-text-white-muted has-text-weight-normal">Let's connect!</h1>
                        </div>
                    </div>
                    <div class="social-icons">
                        <p class="field">
                            <a class="Social-button button is-medium" href="https://www.linkedin.com/in/majkravos/" target="_blank noopener noreferrer">
                            ...
                            <a class="Social-button button is-medium" href="https://github.com/mkravos" target="_blank noopener noreferrer">
                                <span class="icon is-small">
                            ...
                            <a class="Social-button button is-medium" href="mailto:maj@kravos.me">
                                <span class="icon is-small">
                    ...
                    <div class="copyright has-text-white-muted">Crafted by Maj Kravos<span class="icon" >&copy;</span>{currentYear}</div>
                </div>
            </footer>
        </div>
    );
