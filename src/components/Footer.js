            ...
            <footer className="Footer section is-primary is-small has-text-centered">
                <div className="container is-narrow"><a className="logo has-text-white" href="/">
                    ...
                    <div className="social-icons">
                        <p className="field">
                            <a className="Social-button button is-medium" href="https://www.linkedin.com/in/majkravos/" target="_blank noopener noreferrer">
                            ...
                            <a className="Social-button button is-medium" href="https://github.com/mkravos" target="_blank noopener noreferrer">
                                <span className="icon is-small">
                            ...
                            <a className="Social-button button is-medium" href="mailto:maj@kravos.me">
                                <span className="icon is-small">
