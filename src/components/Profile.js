...
export default function Profile() {
    ...
    const aboutMe = "As a seasoned Software Engineer, I have a proven track record of creating high-quality applications from concept to development and deployment. My experience spans across front-end, back-end, mobile, and database development, and I pride myself on being a versatile team player who thrives in collaborative environments. I'm always eager to learn about new technology and tackle new challenges. I'm a self starter skilled at troubleshooting bugs and managing multiple tasks efficiently, and I strive to deliver high-quality results in a timely manner. If you are seeking a reliable and skilled Software Engineer to enhance your team's capabilities, I invite you to contact me to discuss how I can contribute to your organization's success."
    const skills = "JavaScript, React, Node.js, Python, Go, Java, Android, HTML, CSS, PostgreSQL, Express, Flask, C#, .NET, C++, Docker, AWS, Azure"
    const work = useState(
        <>
    ...
    const education = "Northern Illinois University: Bachelor of Science in Computer Science"
                    ...
                    <div className="Home-content-mobile">
                        <div className="Profile-header-mobile">
                            ...
                            <div className="Profile-header-text">
                                ...
                                <div className="Muted-mobile-text">{location}</div>
                                <div className="Muted-mobile-text">{social}</div>
                                <div className="PHeader-buttons-mobile">
                                    <button className="Contact-button-mobile" onClick={onShowContactForm}>Contact</button>
